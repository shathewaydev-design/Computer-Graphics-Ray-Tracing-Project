...
// IBowl's parent is ISphere. ISphere's parent is IQuadricSurface, and it's parent
// is IShape. Means we have access to all that parent code
struct IBowl : public ISphere {
	// make as many constructors as you want
	IBowl(const dvec3& center, double rad);

	// we need to implement our own special version of this function
	virtual void findClosestIntersection(const Ray& ray, HitRecord& hit) const;
