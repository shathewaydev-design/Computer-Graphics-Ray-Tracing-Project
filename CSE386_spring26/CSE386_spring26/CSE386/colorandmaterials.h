...
// You could add some of your own color names here.
// The format is (red, green, blue), where each
// of the three values is in the range [0.0, 1.0]
...
const color gray(0.5, 0.5, 0.5); // you get greyscale whenever red=green=blue
const color lightGray(0.8, 0.8, 0.8);
const color darkGray(0.3, 0.3, 0.3);
const color paleGreen(0.75, 1.0, 0.76);

// many rgb systems use integers in the range [0, 255]. 
// Here is how to convert them to [0.0, 1.0]
const color pastelBlue(169/255.0, 245/255.0, 236/255.0);
/**
 * @struct	Material
